    ...
    if (counter && !this.multipleInputs && (inputEl === null || inputEl === void 0 ? void 0 : inputEl.maxlength) !== undefined) {
      ...
      if (counterFormatter === undefined) {
        ...
        try {
          ...
          (0,_index_595d62c9_js__WEBPACK_IMPORTED_MODULE_3__.a)('Exception in provided `counterFormatter`.', e); // Fallback to the default counter formatter when an exception happens
