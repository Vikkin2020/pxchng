...
let AuthService = class AuthService {
  constructor(http, router) {
    this.http = http;
    this.router = router;
    this.baseurl = "https://wapi.aventadorcoin.com/api/";
  } // Get user session
  ...
  getSession() {
    return (0,C_Users_sushe_Downloads_banking_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      return false; // return session;
    })();
  } // Sign in


  signInv2(data) {
    console.log("signInv2");
  ...
  getETHWallet() {
    ...
    return this.http.get(this.baseurl + 'secure/ETH_wallets', {
      headers: headers
    }).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_2__.catchError)(e => (0,rxjs__WEBPACK_IMPORTED_MODULE_3__.throwError)(e)));
  }
  ...
  getTronWallet() {
    ...
    return this.http.get(this.baseurl + 'secure/Tron_wallets', {
      headers: headers
    }).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_2__.catchError)(e => (0,rxjs__WEBPACK_IMPORTED_MODULE_3__.throwError)(e)));
  }
  ...
  send_fund(data) {
    ...
    return this.http.post(this.baseurl + 'secure/send_fund', data, {
      headers: headers
    });
  }
  ...
  wallets() {
    ...
    return this.http.get(this.baseurl + 'secure/wallets', {
      headers: headers
    }).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_2__.catchError)(e => (0,rxjs__WEBPACK_IMPORTED_MODULE_3__.throwError)(e)));
  }
  ...
  update_profile(data) {
    ...
    return this.http.post(this.baseurl + 'secure/update_profile', data, {
      headers: headers
    });
  }
  ...
  book_trade(data) {
    ...
    return this.http.post(this.baseurl + 'exchange/book_trade', data, {
      headers: headers
    });
  }
  ...
  exchange_rate(data) {
    ...
    return this.http.post(this.baseurl + 'exchange/exchange_rate', data, {
      headers: headers
    });
  }
...
const getScrollElement = /*#__PURE__*/function () {
  var _ref = (0,C_Users_sushe_Downloads_banking_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (el) {
    if (isIonContent(el)) {
