...
/* harmony import */ var _filter_page_html_ngResource__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./filter.page.html?ngResource */ 94696);
/* harmony import */ var _filter_page_scss_ngResource__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./filter.page.scss?ngResource */ 25055);
...
let FilterPage = class FilterPage {
    ...
    onDateFromSelect(event) {
        this.date_from = (0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])((0,date_fns__WEBPACK_IMPORTED_MODULE_3__["default"])(event.detail.value), 'MMM d, yyyy');
        ;
        this.date_from_active = false;
    }
    // On date to select
    onDateToSelect(event) {
        this.date_to = (0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])((0,date_fns__WEBPACK_IMPORTED_MODULE_3__["default"])(event.detail.value), 'MMM d, yyyy');
        ;
        this.date_to_active = false;
    }
    // On range change
...
FilterPage = (0,tslib__WEBPACK_IMPORTED_MODULE_5__.__decorate)([
    (0,_angular_core__WEBPACK_IMPORTED_MODULE_6__.Component)({
        selector: 'app-filter',
        template: _filter_page_html_ngResource__WEBPACK_IMPORTED_MODULE_0__,
        styles: [_filter_page_scss_ngResource__WEBPACK_IMPORTED_MODULE_1__]
    })
], FilterPage);
...
/* harmony import */ var _payments_page_html_ngResource__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./payments.page.html?ngResource */ 8390);
/* harmony import */ var _payments_page_scss_ngResource__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./payments.page.scss?ngResource */ 38585);
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! @angular/core */ 22560);
/* harmony import */ var _ionic_angular__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! @ionic/angular */ 75992);
/* harmony import */ var _filter_filter_page__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./filter/filter.page */ 5617);
...
let PaymentsPage = class PaymentsPage {
  constructor(routerOutlet, modalController, authService, loadingController, formBuilder, toastService, router) {
  ...
  filter() {
    ...
    return (0,C_Users_sushe_Downloads_banking_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      yield modal.present(); // Apply filter from modal
      ...
      if (data) {
        // Reload
        _this.content_loaded = false; // Fake timeout
  ...
  loaddata() {
    ...
    return (0,C_Users_sushe_Downloads_banking_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      _this2.authService.transactions().subscribe(data => {
        _this2.transactions = data;
        console.log(data); //  this.router.navigate(['/home']);

        _this2.content_loaded = true;
        loading.dismiss();
      });
    })();
  }
...
PaymentsPage = (0,tslib__WEBPACK_IMPORTED_MODULE_9__.__decorate)([(0,_angular_core__WEBPACK_IMPORTED_MODULE_10__.Component)({
  selector: 'app-payments',
  template: _payments_page_html_ngResource__WEBPACK_IMPORTED_MODULE_1__,
  styles: [_payments_page_scss_ngResource__WEBPACK_IMPORTED_MODULE_2__]
})], PaymentsPage);
...
/***/ 25055:
/*!**************************************************************************!*\
  !*** ./src/app/pages/secure/payments/filter/filter.page.scss?ngResource ***!
  \**************************************************************************/
/***/ ((module) => {
...
/***/ 94696:
/*!**************************************************************************!*\
  !*** ./src/app/pages/secure/payments/filter/filter.page.html?ngResource ***!
  \**************************************************************************/
/***/ ((module) => {

module.exports = "<ion-header>\n  <ion-toolbar>\n    <ion-buttons slot=\"start\">\n      <ion-button (click)=\"cancel()\">\n        Cancel\n      </ion-button>\n    </ion-buttons>\n    <ion-title>\n      Filter\n    </ion-title>\n    <ion-buttons slot=\"end\">\n      <ion-button (click)=\"apply()\">\n        Apply\n      </ion-button>\n    </ion-buttons>\n  </ion-toolbar>\n</ion-header>\n\n<ion-content>\n\n  <div class=\"ion-padding\">\n\n    <ion-list-header class=\"ion-list-header-small\">\n      <ion-label>Data</ion-label>\n    </ion-list-header>\n\n    <ion-list class=\"list-custom\" lines=\"full\">\n      <ion-item>\n        <ion-label>\n          <p>Categories</p>\n        </ion-label>\n        <ion-select [interfaceOptions]=\"customPopoverOptions\" interface=\"popover\" value=\"all\" placeholder=\"All\">\n          <ion-select-option value=\"all\">All</ion-select-option>\n          <ion-select-option value=\"uncategorized\">Uncategorized</ion-select-option>\n          <ion-select-option value=\"salary\">Salary</ion-select-option>\n          <ion-select-option value=\"rent\">Rent</ion-select-option>\n        </ion-select>\n      </ion-item>\n      <ion-item>\n        <ion-label>\n          <p>Contracts</p>\n        </ion-label>\n        <ion-select [interfaceOptions]=\"customPopoverOptions\" interface=\"popover\" value=\"all\" placeholder=\"All\">\n          <ion-select-option value=\"all\">All</ion-select-option>\n          <ion-select-option value=\"contracts-only\">Contracts only</ion-select-option>\n        </ion-select>\n      </ion-item>\n    </ion-list>\n\n    <hr class=\"hr-medium\">\n\n    <ion-list-header class=\"ion-list-header-small\">\n      <ion-label>Timescale</ion-label>\n    </ion-list-header>\n\n    <ion-list class=\"list-custom\" lines=\"full\">\n      <ion-item>\n        <ion-label>\n          <p>From</p>\n        </ion-label>\n        <ion-input readonly slot=\"end\" type=\"text\" placeholder=\"Date from\" class=\"ion-text-right ion-no-padding-end\"\n          (click)=\"toggleDateFrom()\" [(ngModel)]=\"date_from\"></ion-input>\n      </ion-item>\n      <ion-datetime class=\"animate__animated animate__fadeIn\" *ngIf=\"date_from_active\" color=\"primary\" locale=\"en-EN\"\n        size=\"cover\" showDefaultButtons=\"false\" presentation=\"date\" (ionChange)=\"onDateFromSelect($event)\">\n      </ion-datetime>\n\n      <ion-item>\n        <ion-label>\n          <p>To</p>\n        </ion-label>\n        <ion-input readonly slot=\"end\" type=\"text\" placeholder=\"Date to\" class=\"ion-text-right ion-no-padding-end\"\n          (click)=\"toggleDateTo()\" [(ngModel)]=\"date_to\"></ion-input>\n      </ion-item>\n      <ion-datetime class=\"animate__animated animate__fadeIn\" *ngIf=\"date_to_active\" color=\"primary\" locale=\"en-EN\"\n        size=\"cover\" showDefaultButtons=\"false\" presentation=\"date\" (ionChange)=\"onDateToSelect($event)\">\n      </ion-datetime>\n    </ion-list>\n\n    <hr class=\"hr-medium\">\n\n    <ion-list-header class=\"ion-list-header-small\">\n      <ion-label>Amount</ion-label>\n    </ion-list-header>\n\n    <ion-list class=\"list-custom\" lines=\"full\">\n      <ion-item lines=\"none\" class=\"item-range\">\n        <ion-range id=\"dual-range\" dualKnobs=\"true\" min=\"0\" max=\"1000\" step=\"10\" (ionChange)=\"rangeChanged($event)\"></ion-range>\n      </ion-item>\n      <ion-item class=\"range-values\">\n        <div slot=\"start\">${{range_value_lower}}</div>\n        <div slot=\"end\">${{range_value_upper}}</div>\n      </ion-item>\n    </ion-list>\n\n  </div>\n\n</ion-content>";
